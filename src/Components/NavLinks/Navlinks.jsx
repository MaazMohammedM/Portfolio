    ...
    return(
        <nav className={clsx(`${className}`)}>
            <ul className={clsx(`flex justify-between items-center font-primary ${classNameLink}`)}>
                <li><a className="sm:py-4 sm:px-6 text-sm px-0 py-4 block text-neutral-50 hover:text-neutral-400 transition-all duration-150" href="index.html">Home</a></li>
                ...
                <li><a className="sm:py-4 sm:px-6 text-sm px-0 py-4 block text-neutral-50 hover:text-neutral-400 transition-all duration-150" href="#projects">Projects</a></li>
