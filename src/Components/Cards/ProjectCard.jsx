...
const ProjectCard =({backgroundImage,heading,para,link})=>{
    ...
    return(
        <section className="max-w-60 sm:max-w-80 min-w-[15rem] bg-neutral-50 rounded-2xl hover:scale-105 transition-all">
            ...
            <a type="button" className="text-accent-700 mx-2 text-xs sm:text-sm mb-2 w-[100%-0.5rem] text-center rounded-lg py-1 block hover:text-accent-400" href={link}>View Project &#62;</a>
        </section>
    )
}
